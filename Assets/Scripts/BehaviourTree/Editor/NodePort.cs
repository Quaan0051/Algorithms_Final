...
public class NodePort : Port
{
    ...
    public NodePort(Direction direction, Capacity capacity, Orientation portOrientation = Orientation.Vertical) : base(portOrientation, direction, capacity, typeof(bool))
    {
